---
kind: tool
purpose: fetch edookit updates, format a markdown summary, translate it, and email the result
visibility: public
---
...
- `working-notes/` is excluded via `.git/info/exclude` (public repo, not committed).
